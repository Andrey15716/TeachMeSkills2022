...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        clothes[0] = new Skirt(ClothesSize.S, "white", 123);
        clothes[1] = new Pants(ClothesSize.M, "black", 112);
        clothes[2] = new Tie(ClothesSize.S, "red", 68);
        clothes[3] = new Tshirt(ClothesSize.XS, "brown", 68);
