public class User {
    ...
    public User(String name, String surname, int age, int height, String about) {
        this.name = name;
    ...
    public void getFullInformation() {
        System.out.println("Меня зовут " + name + " " + surname + ".Мне " + age + " лет, " + " вес " + height + "кг.О себе " + about);
    }
