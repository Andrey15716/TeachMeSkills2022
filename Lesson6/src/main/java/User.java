public class User {
    ...
    public User(String name, String surname) {
        ...
        System.out.println("Конструктор с именем и фамилией");
    }

    @Deprecated
    public User(int age) {
        this(30, 2);
        System.out.println("Конструктор с возрастом и весом");
    }
    ...
    public User() {
        this.about = "I am a human";
        System.out.println("Конструктор о себе");
    }

    public static void info() {
        System.out.println("Привет, меня зовут " + User.name);
    }
