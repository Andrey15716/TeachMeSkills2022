...
<div class="container-fluid">
    ...
    <div class="row">
        <p align="left" style="font-size: 22px">Мобильные телефоны</p>
        <c:forEach items="${mobiles}" var="mobile">
            <div class="block1">
                <p>Наименование</p>
                <a>${mobile.getName()}</a>
                <p>Описание</p>
                <a>${mobile.getDescription()}</a>
                <p>Цена</p>
                <a>${mobile.getPrice()}</a>
            </div>
            <div class="card w-25 m-1" type="mobile">
                <div class="card-body">
                    <a>${mobile.getName()}</a>
                    <img class="card-img" style="width:150px;height:120px"
                         src="${contextPath}/images/${mobile.getImageName()}" alt="Mobiles images">
