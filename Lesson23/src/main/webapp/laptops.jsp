...
<div class="container-fluid">
    ...
    <div class="row">
        <p align="left" style="font-size: 22px">Ноутбуки</p>
        <c:forEach items="${laptops}" var="laptop">
            <div class="block1">
                <p>Наименование</p>
                <a>${laptop.getName()}</a>
                <p>Описание</p>
                <a>${laptop.getDescription()}</a>
                <p>Цена</p>
                <a>${laptop.getPrice()}</a>
            </div>
            <div class="card w-25 m-1" type="laptop">
                <div class="card-body">
                    <a>${laptop.getName()}</a>
                    <img class="card-img" style="width:150px;height:120px"
                         src="${contextPath}/images/${laptop.getImageName()}" alt="Laptops images">
