...
<head>
    ...
    <script type="text/javascript" src="/resources/style.css"></script>
</head>
<body>
...
<div class="container">
    <div class="col-md-8 offset-md-4">
        ...
        <form method="post" action="${contextPath}/eshop?command=confirmRegistration" class="needs-validation"
              novalidate>
