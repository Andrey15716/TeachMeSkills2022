    ...
    <div class="col-md-8 offset-md-4">
        <form method="post">
            <div class="form-group">
                <label for="searchParameter">Product:</label>
                <input type="text" class="form-control w-25" id="searchParameter" name="searchParameter"
        ...
        <div class="container-fluid mb-4">
            ...
            <div class="card w-25 m-1" type="searchItem">
                <div>
                    <a href="${contextPath}/eshop?command=product-redirect&product_id=${searchItem.getId()}&name=${searchItem.getName()}"></a>
